			...
			<div class="row">
					...
					@if (
						...
						<div class="{{ $colClass4 }}">
							<div class="footer-col row">
								...
								@endif
								<div class="col-sm-12 col-xs-6 col-xs-12 no-padding-lg mt-4 pt-5 ml-n5">
            					    <ul class="nav navbar-nav" style="margin: 0 0rem 0 -7rem;">
				...
				<div class="col-xl-12">
					...
					<div class="copy-info text-center">
						@ {{ date('Y') }} AG-GALLADO POLSKA. Powered by AG-GALLADO POLSKA
					</div>
				</div>
