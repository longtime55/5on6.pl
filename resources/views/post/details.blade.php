						...
						<div class="posts-image">
							...
							@if (count($post->pictures) > 0)
								<ul class="bxslider">
									@foreach($post->pictures as $key => $image)
										<li class="slide-image slide-image{{ $key }}"><img src="{{ resize($image->filename, 'big') }}" alt="{{ $titleSlug . '-big-' . $key }}"></li>
									@endforeach
								</ul>
								<div class="product-view-thumb-wrapper">
									...
									@foreach($post->pictures as $key => $image)
										<li>
											<a class="group3 thumb-item-link" rel="group3" data-slide-index="{{ $key }}" href="{{ resize($image->filename, 'big') }}">
							...
							@else
								...
								<div class="product-view-thumb-wrapper">
									<ul id="bx-pager" class="product-view-thumb">
										<li>
											<a class="group3 thumb-item-link" rel="group3" data-slide-index="0" href="{{ resize(config('larapen.core.picture.default'), 'big') }}">
